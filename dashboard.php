...
<!--Bulb Range Slider/Toggle-->
			...
			<div>
			<input onclick= "changeB(this,event)" type="button" style="width:200px;margin-left:80px;background-color: #007BFF;border-radius: 4px;border-style:none" value="On" id="Button1">
		</div>
	</div>
	</div>
	</div>
